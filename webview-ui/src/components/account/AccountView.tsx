...
import type { CloudUserInfo } from "@siid-code/types"
import { TelemetryEventName } from "@siid-code/types"
...
export const AccountView = ({ userInfo, isAuthenticated, cloudApiUrl, onDone }: AccountViewProps) => {
	...
	const rooLogoUri = (window as any).IMAGES_BASE_URI + "/pro-logo.svg"
